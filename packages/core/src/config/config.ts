...
export class Config {
  ...
  private displayModel?: string; // For multi-model display purposes
  ...
  getModel(): string {
    return this.displayModel || this.contentGeneratorConfig?.model || this.model;
  }
  ...
  setModel(newModel: string): void {
    if (this.contentGeneratorConfig) {
      ...
      // Fallback: Update the display model property for multi-model environments
      // This is important when contentGeneratorConfig may not exist
  ...
  async createToolRegistry(): Promise<ToolRegistry> {
    ...
    registerCoreTool(TodoTool, this);
